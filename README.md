...
- IVD汎用電子の異体字セレクタでも表現できない異体字２文字（顛および儲）⇒ 最も字形の近い異体字にマッピング
- 変体仮名　⇒　最も字形の近い異体字にマッピング
- グラフ図形など一部の記号 ⇒　説明付き文字列に変換
- 縦書き文字　⇒　説明付き文字列に変換
...
- 2019/9/20 version 1.0.0: FACOM JEF 文字コード索引辞書 (1987年/第三版) に基づきマッピング等の見直しを行いました。
